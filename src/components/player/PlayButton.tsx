    ...
    return (
        ...
        >
            <Show when={player.isPlaying}>
                <svg width="30" height="32" fill="none" class="opacity-50 group-hover:opacity-100 transition-all">
                    <rect x="6" y="4" width="4" height="24" rx="2" fill="currentColor" stroke="currentColor"></rect>
                    <rect x="20" y="4" width="4" height="24" rx="2" fill="currentColor" stroke="currentColor"></rect>
                </svg>
            </Show>
            <Show when={!player.isPlaying}>
                <svg
                    width="30"
                    height="32"
                    class="opacity-50 group-hover:opacity-100 transition-all"
                    fill="none"
                    stroke="none"
                >
                    <g transform="matrix(0.35614236,0,0,-0.31011198,-3688.5482,5221.6785)" fill="none" stroke="none">
                        <path
